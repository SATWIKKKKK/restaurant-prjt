  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-hidden shadow-2xl shadow-purple-500/20 animate-slideUp">
        <div className="sticky top-0 bg-black/90 backdrop-blur-xl border-b border-white/10 px-6 sm:px-8 py-6 flex justify-between items-center">
          <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-purple-400 to-orange-400 bg-clip-text text-transparent">
            Your Cart
          </h2>
          <button 
        ...
        <div className="p-6 sm:p-8 overflow-y-auto max-h-[calc(90vh-100px)]">
          {orderSuccess ? (
            <div className="text-center py-20 animate-fadeIn">
              <div className="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-br from-green-500/20 to-green-500/10 rounded-full mb-6 animate-bounce">
            ...
            <div>
              ...
              <div className="space-y-4">
                <input
                  ...
                  className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all placeholder-gray-500"
                />
                <input
                  type="email"
                ...
                <textarea
                  ...
                  className="w-full px-6 py-4 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all placeholder-gray-500 resize-none"
                />
                <button
                  onClick={handleSubmitOrder}
                  className="w-full py-5 bg-gradient-to-r from-purple-600 to-orange-600 rounded-xl font-bold text-lg hover:shadow-2xl hover:shadow-purple-500/50 transition-all transform hover:scale-[1.02] active:scale-95"
                >
